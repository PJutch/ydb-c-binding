...
TParams CreateParams() {
    TSeries seriesData[] = {
        {
            1, "IT Crowd",  ParseIso8601("2006-02-03"),
    ...
    TEpisode episodesData[] = {
        ...
        {1, 1, 4, "The Red Door", ParseIso8601("2006-02-17")},
        {1, 1, 5, "The Haunting of Bill Crouse", ParseIso8601("2006-02-24")},
        {1, 1, 6, "Aunt Irma Visits", ParseIso8601("2006-03-03")},
        {1, 2, 1, "The Work Outing", ParseIso8601("2006-08-24")},
        {1, 2, 2, "Return of the Golden Child", ParseIso8601("2007-08-31")},
        {1, 2, 3, "Moss and the German", ParseIso8601("2007-09-07")},
        {1, 2, 4, "The Dinner Party", ParseIso8601("2007-09-14")},
        ...
        {1, 3, 3, "Tramps Like Us", ParseIso8601("2008-12-05")},
        {1, 3, 4, "The Speech", ParseIso8601("2008-12-12")},
        {1, 3, 5, "Friendface", ParseIso8601("2008-12-19")},
        {1, 3, 6, "Calendar Geeks", ParseIso8601("2008-12-26")},
        {1, 4, 1, "Jen The Fredo", ParseIso8601("2010-06-25")},
        {1, 4, 2, "The Final Countdown", ParseIso8601("2010-07-02")},
        ...
        {2, 1, 2, "The Cap Table", ParseIso8601("2014-04-13")},
        ...
        {2, 1, 6, "Third Party Insourcing", ParseIso8601("2014-05-11")},
        {2, 1, 7, "Proof of Concept", ParseIso8601("2014-05-18")},
        {2, 1, 8, "Optimal Tip-to-Tip Efficiency", ParseIso8601("2014-06-01")},
        ...
        {2, 2, 4, "The Lady", ParseIso8601("2015-05-03")},
        ...
        {2, 2, 10, "Two Days of the Condor", ParseIso8601("2015-06-14")},
        {2, 3, 1, "Founder Friendly", ParseIso8601("2016-04-24")},
        {2, 3, 2, "Two in the Box", ParseIso8601("2016-05-01")},
        {2, 3, 3, "Meinertzhagen's Haversack", ParseIso8601("2016-05-08")},
        {2, 3, 4, "Maleant Data Systems Solutions", ParseIso8601("2016-05-15")},
        {2, 3, 5, "The Empty Chair", ParseIso8601("2016-05-22")},
        {2, 3, 6, "Bachmanity Insanity", ParseIso8601("2016-05-29")},
        {2, 3, 7, "To Build a Better Beta", ParseIso8601("2016-06-05")},
        {2, 3, 8, "Bachman's Earnings Over-Ride", ParseIso8601("2016-06-12")},
        {2, 3, 9, "Daily Active Users", ParseIso8601("2016-06-19")},
        {2, 3, 10, "The Uptick", ParseIso8601("2016-06-26")},
        {2, 4, 1, "Success Failure", ParseIso8601("2017-04-23")},
        {2, 4, 2, "Terms of Service", ParseIso8601("2017-04-30")},
        {2, 4, 3, "Intellectual Property", ParseIso8601("2017-05-07")},
        {2, 4, 4, "Teambuilding Exercise", ParseIso8601("2017-05-14")},
        {2, 4, 5, "The Blood Boy", ParseIso8601("2017-05-21")},
        {2, 4, 6, "Customer Service", ParseIso8601("2017-05-28")},
        {2, 4, 7, "The Patent Troll", ParseIso8601("2017-06-04")},
        {2, 4, 8, "The Keenan Vortex", ParseIso8601("2017-06-11")},
        ...
        {2, 5, 4, "Tech Evangelist", ParseIso8601("2018-04-15")},
    ...
    TParamsBuilder paramsBuilder = CreateParamsBuilder();

    TParamValueBuilder seriesParam = AddParam(paramsBuilder, "$seriesData");
    ...
    for (int i = 0; i < ARRAY_LEN(seriesData); ++i) {
        ParamAddListItem(seriesParam);
            ...
            ParamAddMember(seriesParam, "title");
                ParamUtf8(seriesParam, seriesData[i].Title);
    ...
    TParamValueBuilder seasonsParam = AddParam(paramsBuilder, "$seasonsData");
    ...
    for (int i = 0; i < ARRAY_LEN(seasonsData); ++i) {
        ParamAddListItem(seasonsParam);
            ...
            ParamAddMember(seasonsParam, "title");
                ParamUtf8(seasonsParam, seasonsData[i].Title);
    ...
    TParamValueBuilder episodesParam = AddParam(paramsBuilder, "$episodesData");
    ...
    for (int i = 0; i < ARRAY_LEN(episodesData); ++i) {
        ParamAddListItem(episodesParam);
            ...
            ParamAddMember(episodesParam, "title");
                ParamUtf8(episodesParam, episodesData[i].Title);
